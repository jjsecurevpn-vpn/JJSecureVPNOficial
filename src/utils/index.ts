...
export {
  // VPN
  // getConnectionState,  // ← REMOVIDO: Usar nativeAPI.vpn.getState()
  // startConnection,     // ← REMOVIDO: Usar nativeAPI.vpn.start()
  // stopConnection,      // ← REMOVIDO: Usar nativeAPI.vpn.stop()
  
  // Red
  // getDescargaBytes,    // ← REMOVIDO: Usar nativeAPI.network.getDownloadBytes()
  // getSubidaBytes,      // ← REMOVIDO: Usar nativeAPI.network.getUploadBytes()
  ...
  // Configuración
  // getActiveConfig,     // ← REMOVIDO: Usar nativeAPI.config.getActive()
  // shouldShowInput,     // ← REMOVIDO: Usar nativeAPI.auth.shouldShowInput()
