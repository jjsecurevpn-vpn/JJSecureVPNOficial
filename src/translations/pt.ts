...
export const pt: Translations = {
  ...
  settings: {
    ...
    premiumInfo: {
      title: "Informações Premium",
      subtitle:
        "Obtenha acesso premium com servidores de alta velocidade e menor latência.",
      description:
        "Desfrute de localizações exclusivas e suporte prioritário quando mais precisar.",
      features: [
        "Maior velocidade em horários de pico e maior estabilidade.",
        "Mais localizações e servidores disponíveis.",
    ...
    premiumFeatures: {
      ...
      features: {
        globalCoverage: {
          ...
          description: "Mais de 14900 localizações de servidores em 122 países",
        },
        fasterBrowsing: {
          title: "Navegação mais rápida",
          description: "Navegue em velocidades ainda maiores (até 10 Gbps)",
        },
        advancedSecurity: {
          title: "Segurança Avançada",
          description: "Criptografia AES-256 e kill switch",
        },
      },
    },
  },
  freeServersInfoModal: {
    ...
    subtitle:
      "Todos os nossos servidores gratuitos passam por canais oficiais seguros",
    stats: {
      freeServers: "Servidores Gratuitos",
      premiumServers: "Servidores Premium",
    },
    availableConnections: "Conexões Gratuitas Disponíveis",
    selectFreeServer: "Selecione um servidor gratuito:",
    serverDescription: "Canal oficial • Conexão estável",
    moreServersAvailable: "+{count} servidores mais disponíveis",
    upgradeTitle: "Quer mais velocidade?",
    upgradeMessage: "Atualize para Premium para {count} servidores exclusivos",
    upgradeButton: "Atualizar para Premium",
    closeButton: "Fechar",
    loadError: "Erro ao carregar servidores:",
  },
  footer: {
    tabs: {
      home: "INÍCIO",
