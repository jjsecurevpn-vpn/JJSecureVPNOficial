...
interface ScreenLayoutProps {
  ...
  /** Contenido personalizado para el header (reemplaza título/subtítulo). Puede ser un nodo o un renderer que recibe el estado de scroll. */
  headerContent?: React.ReactNode | ((state: { isScrolled: boolean }) => React.ReactNode);
  
  /** Contenido personalizado para el extremo derecho del header */
  headerRightContent?: React.ReactNode;
  
  /** Altura personalizada del header */
  headerHeight?: number;
...
export const ScreenLayout: React.FC<ScreenLayoutProps> = ({
  ...
  const defaultHeaderHeight = subtitle && !headerContent ? 100 : 68;
  const headerHeight = hideHeader ? 0 : (customHeaderHeight ?? defaultHeaderHeight);
  ...
  const headerBg = isScrolled ? colors.background.footer : backgroundColor;
      ...
      {!hideHeader && (
        ...
        >
          ...
          <div
            ...
            style={{ height: headerHeight, width: '100%', paddingLeft: horizontalPadding, paddingRight: horizontalPadding }}
          >
            ...
            {/* Lado derecho - Botón de menú o contenido personalizado */}
