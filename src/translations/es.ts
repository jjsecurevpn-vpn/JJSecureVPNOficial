...
export const es: Translations = {
  ...
  hotspot: {
    ...
    startingDescription: "Preparando el hotspot, espera un momento...",
    stoppingDescription: "Finalizando conexiones activas...",
    checkingStatus: "Verificando estado...",
    unknownDescription: "Verificando el estado del servicio de hotspot...",
  ...
  serverSelectorScreen: {
    ...
    flowGuide: {
      title: "1. Elige una categoría",
      subtitle: "2. Debajo verás los servidores disponibles",
      helper: "Selecciona una categoría en el encabezado para mostrar los servidores y tócalos para conectarte.",
    },
    serverView: {
      ...
      connecting: "Conectando...",
      descriptionToggle: {
        show: "Ver descripción",
        hide: "Ocultar descripción",
      },
    },
    loadingView: {
    ...
    descriptionToggle: {
      show: "Mostrar descripciones",
      hide: "Ocultar descripciones",
      hint: "Solo se muestra el nombre y el protocolo; activa para ver más detalles.",
    },
  },
};
